    ...
    <div className='w-full mb-4 rounded-lg bg-slate-200 dark:bg-slate-800'>
      <div className='flex items-center justify-between px-3 py-2'>
        <div className='flex w-full items-center'>
          ...
          <div className='flex justify-center w-full flex-wrap items-center space-x-1 sm:pl-4'>
            <p className='font-bold'>Decoded Result</p>
          </div>
        </div>
      ...
      <div className='p-4 bg-slate-200 rounded-b-lg dark:bg-slate-800'>
        <p className='px-2 py-20 block w-full text-md outline-none rounded-lg text-slate-800 bg-slate-100 focus:bg-slate-50 border-0 dark:bg-slate-700 focus:dark:bg-slate-600 focus:ring-0 dark:text-slate-100 dark:placeholder-slate-400'></p>
      </div>
    </div>
  )
}